...
\begin{enumerate}[leftmargin=*,label=\arabic*.]
  ...
  \item Give semantics to the admitted untyped SMT command fragment and prove
...
\section{Untyped (``raw'') SMT semantics}
\sectioncontents{Relational term evaluation; admitted commands; SMT datatype laws; semantic command-set equality.}

The SMT syntax emitted by the Crush translator is intentionally not intrinsically
typed. From this point onward, \emph{raw} means this untyped syntax, in contrast to the typed
HO and FO syntax above. The proof does not claim that every raw term is well
sorted; instead it gives an
...
\begin{itemize}[leftmargin=*]
 ...
 \item Unsupported dependent syntax, indexed or nonproductive inductives,
       ...
       direct higher-order commands remain outside the modeled theorem.
\end{itemize}
