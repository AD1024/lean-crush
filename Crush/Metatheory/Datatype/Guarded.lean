...
abbrev BaseReprs (Source : BaseSort → Type u) (Target : BaseSort → Type v) :=
  ∀ sort, SubsetRepr (Source sort) (Target sort)
...
noncomputable def FieldDecl.fallback {arity : Nat} {block : Block arity}
    ...
    (base : BaseReprs Source Target) (productive : Productive block)
...
theorem Val.isCtor_encode_iff {arity : Nat} {block : Block arity}
    {Source : BaseSort → Type u} {Target : BaseSort → Type v}
    (base : BaseReprs Source Target) {data : DataRef block}
...
mutual
  ...
  theorem Args.encode_wf {arity : Nat} {block : Block arity}
      {Source : BaseSort → Type u} {Target : BaseSort → Type v}
      (base : BaseReprs Source Target) {fields : List (FieldDecl arity)}
...
def FieldDecl.decode {arity : Nat} {block : Block arity}
    {Source : BaseSort → Type u} {Target : BaseSort → Type v}
    (base : BaseReprs Source Target) (field : FieldDecl arity)
...
mutual
  ...
  theorem Args.decode_encode {arity : Nat} {block : Block arity}
    ...
    | nil => rfl
    | base value rest =>
        simp [Args.encode, Args.decode, SubsetRepr.decode_encode,
...
mutual
  ...
  theorem Args.encode_decode {arity : Nat} {block : Block arity}
    ...
    | nil => rfl
    | base value rest =>
        simp [Args.decode, Args.encode, SubsetRepr.encode_decode,
...
def lift {arity : Nat} {block : Block arity}
    {Source : BaseSort → Type u} {Target : BaseSort → Type v}
    (base : BaseReprs Source Target) (productive : Productive block)
    (data : DataRef block) : SubsetRepr (Val block Source data) (Val block Target data) where
