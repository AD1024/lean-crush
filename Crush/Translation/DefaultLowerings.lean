...
Encodings in this module use the same public `@[crush_translate_head target]` API available to
...
/-- Boolean negation uses the closed certified constructor.  Both endpoints are
fixed: Lean `Not`, SMT logical `not`, and `BuiltinHooks.notSemantic` proves the
corresponding semantic relation without an external denotation assumption. -/
...
named alias. -/
@[crush_translate_family Decidable, crush_translate_family DecidableEq]
...
@[crush_translate_head String.append]
...
@[crush_translate_head String.isEmpty]
...
@[crush_translate_head String.isPrefixOf]
...
@[crush_translate_head String.startsWith]
...
@[crush_translate_head String.endsWith]
...
@[crush_translate_head String.contains, crush_translate_head String.any]
...
@[crush_translate_head HAppend.hAppend]
...
`@[crush_translate_head]` handlers. The helper returns `none` when a custom sort handler
...
@[crush_translate_head Array.replicate]
...
@[crush_translate_head Array.size]
...
@[crush_translate_head GetElem.getElem]
...
@[crush_translate_head Array.set]
...
@[crush_translate_head Array.setIfInBounds]
...
@[crush_translate_head Array.push]
...
@[crush_translate_head Array.pop]
